...
impl Machine {
    ...
    pub fn build(max_travels: Point, units: Unit) -> Result<Self, MachineError> {
        Ok(Machine {
            ...
            code_units: units,
            max_travels,
            work_offset: Point::new(0.0, 0.0, 0.0),
    ...
    fn new_pos(&self, mut pos: PartialPoint) -> Point {
        ...
        match self.positioning {
            Positioning::Absolute => Point::new(
                pos.x.map_or(self.pos().x, |x| self.work_offset().x + x),
                pos.y.map_or(self.pos().y, |y| self.work_offset().y + y),
                pos.z.map_or(self.pos().z, |z| self.work_offset().z + z),
            ),
